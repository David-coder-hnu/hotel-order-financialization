...
\caption{Monte Carlo tranche loss distribution from the full ternary-settlement engine (10,000 paths). Expected loss and VaR 95\% are near zero for all tranches. Note: in the simplified default model without ternary settlement, Senior EL = 1.20\%; the gap reflects the loss-absorption value of the settlement mechanism.}
\label{fig:mc}
\end{figure}
