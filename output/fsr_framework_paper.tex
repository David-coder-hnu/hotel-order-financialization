...
A stakeholder analysis reveals a positive-sum coordination mechanism: hotels capture $\approx$78\% of net benefits, institutional investors 16\%, users 5\% (through market-driven booking discounts), and the platform $\approx$1\%. Per available room-night, the Time-Right model delivers 55\% more hotel revenue than OTA distribution, because Time-Right revenue is guaranteed occupancy-independent.
...
Hotels capture approximately 78\% of the system's net benefit (\yen 809M/year for the 66-hotel pool), primarily through front-loaded certain cash that eliminates occupancy risk and OTA commissions.
Critically, when computed per \emph{available} room-night (accounting for the 62\% expected occupancy under traditional operations), the Time-Right model delivers 55\% more hotel revenue than OTA distribution (\yen 1,602 vs.\ \yen 1,032 per available room-night)---because Time-Right revenue is guaranteed regardless of whether the room is occupied.
Institutional investors earn 16\% through fixed-income tranche coupons.
Users capture 5\% of system value through market-driven booking discounts (\yen 90 saved per room-night, or 4.4\% below spot), funded entirely by secondary-market liquidity rather than hotel margin compression.
The platform earns approximately 1\% as market infrastructure, with a deliberate fee structure that charges 5$\times$ more for cash redemption than secondary-market trading, incentivizing users to recycle value within the ecosystem.
Retail investors earn $\approx$73\% nominal return on Time-Right holdings, compensated for bearing hotel default risk and illiquidity.
The system's value is asymmetric across hotel tiers: economy and comfort-tier hotels with high OTA dependence and costly financing benefit most, while luxury hotels with stable occupancy and brand-direct bookings benefit least.
...
\begin{table}[H]
\centering
\caption{Stakeholder benefit distribution (66-hotel pool, annualized, CNY)}
\label{tab:stakeholders}
\begin{tabular}{@{}lrll@{}}
\toprule
\textbf{Stakeholder} & \textbf{Net Benefit} & \textbf{Share} & \textbf{Value Proposition} \\
\midrule
Hotels         & \yen 809M & 77.8\% & Guaranteed revenue, no OTA, no debt \\
Institutional  & \yen 169M & 16.2\% & Senior Aaa-rated fixed income (4.5\%) \\
Users          & \yen 52M  &  5.0\% & Market-driven booking discount (4.4\% vs.\ spot) \\
Platform       & \yen 10M  &  0.9\% & Asset-light infrastructure, scales with volume \\
\midrule
\textbf{Total} & \textbf{\yen 1,040M} & \textbf{100\%} & \\
\bottomrule
\end{tabular}
\end{table}
...
This 55\% advantage per available room-night is the system's primary value proposition for hotel operators.

Users benefit through market-driven discounts: by purchasing a Time-Right at \yen 1,174, selling it on the secondary market at \yen 1,268 (netting \yen 1,264 after the 0.3\% trading fee), and applying the proceeds to a \yen 2,029 hotel booking, the user's total out-of-pocket cost is \yen 1,939---a \yen 90 (4.4\%) saving versus booking directly.
Critically, this discount is funded by secondary-market liquidity, not by hotel margin compression: the hotel receives the full spot price for the booked room.
