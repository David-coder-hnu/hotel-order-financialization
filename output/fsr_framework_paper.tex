...
Monte Carlo simulation (10,000 paths, 36 months) yields near-zero expected losses and Aaa-implied ratings for all tranches, though these results are sensitive to model specification: capped Merton PDs average 49.4\% (65 of 66 hotels at the 50\% ceiling), uncapped Merton reaches 98.2\%, and a simplified KMV model yields 9.8\%.
An empirical survival analysis of 14,851 hotels reveals tiered attrition rates---economy $\approx$36\%, comfort $\approx$14\%, upscale $\approx$5\%, luxury $\approx$0\%---providing a data-driven benchmark between the two model extremes.
The $t$-copula VaR 99\% for the Senior tranche is approximately double the Gaussian estimate, confirming material tail dependence.
...
Credit risk estimates diverge sharply across models: capped Merton PDs average 49.4\% (with 65 of 66 pool hotels at the 50\% ceiling), uncapped Merton PDs reach 98.2\%, and a simplified KMV model yields 9.8\%.
An empirical survival analysis of 14,851 hotels over four months reveals a tiered attrition gradient: economy hotels face $\approx$36\% annualized delisting rates, comfort $\approx$14\%, upscale $\approx$5\%, and luxury $\approx$0\%---consistent with economic intuition but lacking a direct default-calibration benchmark.
Copula sensitivity analysis confirms that the Gaussian copula understates tail dependence: the $t$-copula ($\nu=3$) VaR 99\% for the Senior tranche (50.4\%) is approximately double the Gaussian estimate (24.5\%), though the 32\% Senior credit support absorbs tail events across all specifications.
